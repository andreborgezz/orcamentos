  ...
  var sidebarHTML = '<aside class="sidebar" id="sidebar">' +
    ...
    '<div class="sidebar-footer">' +
      ...
      '<div style="display:flex; gap:4px;">' +
        '<a href="/pages/configuracoes/configuracoes.html" class="sidebar-settings-btn' + (currentPage === 'configuracoes' ? ' active' : '') + '" title="Configurações" style="text-decoration:none;">' +
